...
process.CondDB.connect = 'sqlite_file:../data/OuterTrackerDTCCablingMap.db'
...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring(
		...
		'root://xrootd-cms.infn.it//store/relval/CMSSW_9_3_2/RelValTTbar_14TeV/GEN-SIM-RECO/PU25ns_93X_upgrade2023_realistic_v2_2023D17PU200-v1/10000/025880CF-D5AA-E711-92EF-4C79BA180923.root',
		),
...
process.dtcbandwidthstatisticsanalyzer = cms.EDAnalyzer("DTCBandwidthStatisticsAnalyzer",
	...
	#ClusInputTag = cms.InputTag("siPhase2Clusters"  ,""  ,"RECO"),
